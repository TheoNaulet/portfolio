...
export const projects: Project[] = [
  {
    ...
    image: "/portfolio/images/logo_travelyzer.png",
    showcase: {
      headline: "Le voyage,",
      highlight: "réinventé.",
    ...
    screens: [
      { type: "iphone", label: "AI Planner", gradient: "from-[#C084FC] to-[#F0ABFC]", image: "/portfolio/images/travelyzer_screens/mobile/AI_Mobile.PNG" },
      { type: "iphone", label: "Explorer", gradient: "from-[#A78BFA] to-[#C084FC]", image: "/portfolio/images/travelyzer_screens/mobile/Explore_mobile.PNG" },
      { type: "iphone", label: "Feed", gradient: "from-[#C084FC] to-[#F0ABFC]", image: "/portfolio/images/travelyzer_screens/mobile/feed_mobile.PNG" },
      { type: "iphone", label: "Around Me", gradient: "from-[#F0ABFC] to-[#A78BFA]", image: "/portfolio/images/travelyzer_screens/mobile/around_me_mobile.PNG" },
      { type: "iphone", label: "Profil", gradient: "from-[#A78BFA] to-[#F0ABFC]", image: "/portfolio/images/travelyzer_screens/mobile/Profile_mobile.PNG" },
      { type: "iphone", label: "Pays", gradient: "from-[#C084FC] to-[#A78BFA]", image: "/portfolio/images/travelyzer_screens/mobile/country_sheet_mobile.PNG" },
      { type: "iphone", label: "Ville", gradient: "from-[#F0ABFC] to-[#C084FC]", image: "/portfolio/images/travelyzer_screens/mobile/City_sheet_mobile.PNG" },
      { type: "macbook", label: "AI Planner", gradient: "from-[#C084FC] to-[#F0ABFC]", image: "/portfolio/images/travelyzer_screens/ai_planner/home.png" },
      { type: "macbook", label: "Itinéraire IA", gradient: "from-[#A78BFA] to-[#C084FC]", image: "/portfolio/images/travelyzer_screens/ai_planner/overview.png" },
      { type: "macbook", label: "Dashboard", gradient: "from-[#F0ABFC] to-[#A78BFA]", image: "/portfolio/images/travelyzer_screens/dashboard/dasjboard_global.png" },
      { type: "macbook", label: "Pays", gradient: "from-[#C084FC] to-[#A78BFA]", image: "/portfolio/images/travelyzer_screens/dashboard/country_.png" },
      { type: "macbook", label: "Generations IA", gradient: "from-[#A78BFA] to-[#F0ABFC]", image: "/portfolio/images/travelyzer_screens/dashboard/manage_generations.png" },
      { type: "macbook", label: "Moderation", gradient: "from-[#C084FC] to-[#F0ABFC]", image: "/portfolio/images/travelyzer_screens/dashboard/manage_moderation.png" },
    ],
  },
  {
    name: "Socare",
    ...
    image: "/portfolio/images/logo_socare.webp",
    showcase: {
      headline: "La santé,",
      highlight: "connectée.",
  ...
  },
  {
    ...
    image: "/portfolio/images/logo_cotezilla.png",
    showcase: {
      headline: "Les cotes,",
  ...
  },
  {
    ...
    image: "/portfolio/images/H2Air.png",
    showcase: {
    ...
    screens: [
      { type: "iphone", label: "Around Me", gradient: "from-[#00e5b4] to-[#34d399]", image: "/portfolio/images/h2air/around_me.PNG" },
      { type: "iphone", label: "Itinéraire", gradient: "from-[#34d399] to-[#00e5b4]", image: "/portfolio/images/h2air/itinerary.PNG" },
      { type: "iphone", label: "Communauté", gradient: "from-[#00e5b4] to-[#00b894]", image: "/portfolio/images/h2air/community.PNG" },
      { type: "iphone", label: "Green Impact", gradient: "from-[#00b894] to-[#34d399]", image: "/portfolio/images/h2air/green_impact.PNG" },
      { type: "iphone", label: "Profil", gradient: "from-[#34d399] to-[#00e5b4]", image: "/portfolio/images/h2air/profile.PNG" },
      { type: "iphone", label: "Recherche", gradient: "from-[#00e5b4] to-[#00b894]", image: "/portfolio/images/h2air/search_itinerary.PNG" },
      { type: "iphone", label: "Station", gradient: "from-[#00b894] to-[#34d399]", image: "/portfolio/images/h2air/sheet_station.PNG" },
      { type: "iphone", label: "Véhicule", gradient: "from-[#34d399] to-[#00b894]", image: "/portfolio/images/h2air/vehicle_choice.PNG" },
    ],
  },
  {
    name: "Maz Musique",
    ...
    description:
      "Site vitrine moderne pour Maz Musique, conçu pour mettre en valeur l'univers artistique, les productions et les services proposés. Un design immersif au service de l'identité musicale.",
    role: "Développeur Freelance",
    duration: "2025",
    stack: ["Next.js", "TypeScript", "Tailwind CSS"],
    features: [
      "Design immersif reflétant l'identité musicale",
      "Présentation des services et productions",
...
export const companies: Company[] = [
  {
    ...
    accentColor: "#6D28D9",
    logo: "/portfolio/images/Sonup.png",
  ...
  },
  {
    ...
    accentColor: "#0D9488",
    logo: "/portfolio/images/viatransit.png",
  ...
  },
  {
    ...
    tags: ["Vente", "Tech"],
    accentColor: "#DC2626",
    logo: "/portfolio/images/boulanger.jpg",
  ...
  },
  {
    ...
    accentColor: "#1D4ED8",
    logo: "/portfolio/images/logo_fc_sete.jpg",
...
export const education: Education[] = [
  {
    ...
    logo: "/portfolio/images/openclassrooms.png",
  },
  {
    ...
    logo: "/portfolio/images/Logo_cesi_2022.png",
  },
  {
    ...
    logo: "/portfolio/images/125664_t6.jpg",
  },
  {
    ...
    logo: "/portfolio/images/Logo-ISEFAC-Bachelor.jpg",
  },
];
