...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tagline: "Application cashback nouvelle génération — connectée à ta CB, sans activation.",
    description:
      "Kasha App est une application mobile de cashback nouvelle génération. Contrairement aux solutions existantes, aucune activation n'est nécessaire : l'app est directement connectée à la carte bancaire de l'utilisateur. Chaque achat chez un commerçant partenaire génère automatiquement du cashback. L'utilisateur suit ses gains en temps réel, découvre les commerçants autour de lui et profite de boosts temporaires pour maximiser ses retours.",
    role: "Créateur & Lead Developer",
    duration: "2026",
    ...
    showcase: {
      ...
      sub: "Connecté à ta CB. Pas d'activation. Tu achètes, tu gagnes.",
      highlightColor: "from-[#7C3AED] to-[#00C48C]",
    },
    features: [
      "Cashback automatique connecté à la carte bancaire, sans activation",
      "Découverte de commerçants partenaires avec géolocalisation et carte interactive",
      "Boosts temporaires pour des taux de cashback augmentés",
      "Wallet intégré avec suivi des gains, retraits SEPA et bons d'achat",
      "Système de niveaux de fidélité avec avantages progressifs",
      "Notifications temps réel sur les transactions et offres",
    ],
    status: "in-progress",
    screens: [
      { type: "iphone", label: "Accueil", gradient: "from-[#7C3AED] to-[#00C48C]" },
      { type: "iphone", label: "Explorer", gradient: "from-[#00C48C] to-[#7C3AED]" },
      { type: "iphone", label: "Wallet", gradient: "from-[#7C3AED] to-[#1A0A2E]" },
      { type: "iphone", label: "Profil", gradient: "from-[#1A0A2E] to-[#00C48C]" },
    ],
  },
  {
    name: "Kasha Dashboard",
    slug: "kasha-dashboard",
    year: "2026",
    url: "https://theonaulet.github.io/kasha-dashboard",
    gradient: "from-[#1A72FF] to-[#7C3AED]",
    titleGradient: "linear-gradient(135deg, #1A72FF, #7C3AED, #1A0A2E)",
    tagline: "Dashboard commerçant — analytics client, campagnes cashback et fidélisation.",
    description:
      "Kasha Dashboard est l'interface commerçant de la plateforme Kasha. Un boulanger, un restaurateur ou tout commerçant de proximité peut mieux connaître sa clientèle grâce à des analytics détaillés : démographie, rétention, panier moyen, fréquence d'achat. Il peut créer des campagnes de cashback (standard, boost, acquisition) avec calcul de ROI intégré, et suivre en temps réel l'impact sur son chiffre d'affaires.",
    role: "Créateur & Lead Developer",
    duration: "2026",
    stack: ["Next.js", "TypeScript", "Tailwind CSS", "Shadcn UI", "Recharts", "Zustand"],
    showcase: {
      headline: "Connaissez vos",
      highlight: "clients.",
      sub: "Analytics, campagnes cashback et fidélisation — le tableau de bord pensé pour les commerçants.",
      highlightColor: "from-[#1A72FF] to-[#7C3AED]",
    },
    features: [
      "KPIs en temps réel : clients actifs, panier moyen, fréquence d'achat, revenu",
      "Analytics client : démographie, rétention, risque de churn, zones géographiques",
      "Création de campagnes cashback avec calculateur de ROI intégré",
      "Suivi des performances par campagne avec métriques détaillées",
      "Système de facturation et gestion des intégrations API",
      "Interface créateur/affilié avec suivi des commissions et referrals",
    ],
    status: "in-progress",
    screens: [
      { type: "macbook", label: "Overview", gradient: "from-[#1A72FF] to-[#7C3AED]" },
      { type: "macbook", label: "Clients", gradient: "from-[#7C3AED] to-[#1A72FF]" },
      { type: "macbook", label: "Campagnes", gradient: "from-[#1A72FF] to-[#1A0A2E]" },
      { type: "macbook", label: "Analytics", gradient: "from-[#1A0A2E] to-[#1A72FF]" },
    ],
  },
  {
    name: "Kasha Landing",
    ...
    year: "2026",
    url: "https://theonaulet.github.io/kasha-dashboard",
    gradient: "from-[#00C48C] to-[#1A72FF]",
    titleGradient: "linear-gradient(135deg, #00C48C, #1A72FF, #7C3AED)",
    tagline: "Landing page de présentation de la plateforme Kasha pour commerçants et utilisateurs.",
    description:
      "Page de présentation de Kasha destinée à convertir les commerçants et les utilisateurs. Elle met en avant la proposition de valeur du cashback automatique côté consommateur et les outils d'analytics et de fidélisation côté commerçant, avec un design moderne et des sections pensées pour la conversion.",
    role: "Créateur & Lead Developer",
    duration: "2026",
    stack: ["Next.js", "TypeScript", "Tailwind CSS", "Framer Motion"],
    showcase: {
      headline: "Le cashback",
      highlight: "réinventé.",
      sub: "Pour les consommateurs, pour les commerçants. Une plateforme, deux univers.",
      highlightColor: "from-[#00C48C] to-[#1A72FF]",
    },
    features: [
      "Hero impactant avec proposition de valeur claire",
      "Sections dédiées commerçants et utilisateurs",
      "Showcase des fonctionnalités clés avec animations",
      "FAQ et témoignages pour rassurer les prospects",
      "Design conversion-oriented avec CTA stratégiques",
    ],
    status: "in-progress",
    screens: [
      { type: "macbook", label: "Hero", gradient: "from-[#00C48C] to-[#1A72FF]" },
      { type: "macbook", label: "Business", gradient: "from-[#1A72FF] to-[#00C48C]" },
    ],
  },
  {
