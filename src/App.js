        ...
        <div className="me">
            ...
            <div className='wrapper'>
              <div className='work' id="work1">
                <div className='description'>
                  <p className='date'>Nov. 2021 - Déc. 2021</p>
                  <p className='poste'>Conseiller de vente multimédia</p>
                </div>
              </div>
          ...
          <div className='bottom'>
            <div className='contact'>
              ...
              <a class="email" href='mailto:theo.naulet@gmail.com'>theo.naulet@gmail.com</a>
