        ...
        <div className='wrapper'>
			<div className="box">
            	<div className='imgBox'>
            		<img style={{backgroundColor:"white"}} id='imgwork' src="https://static.data.gouv.fr/images/38/55bf16d4c34040b47ddfdaa8bf4f27.png" alt='Logo viaTransit'></img>
            	</div>
            	<div className="content">
					<h2>Développeur fullstack</h2>
					<span>Nov. 22 - Mars. 23</span>
            	</div>
            </div>
            <div className="box">
            	<div className='imgBox'>
